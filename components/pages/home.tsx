          ...
          <div className="mb-6 mt-4 flex h-32 flex-col gap-3 md:my-0 md:flex-row md:items-center xl:flex-row">
            ...
            <div className="relative rounded-md xl:w-auto">
              <button
                ...
                className="flex w-full items-center justify-center rounded-md border border-gray-700 bg-white/10 px-2 py-3 font-mono text-sm font-medium text-gray-300 hover:bg-gray-900 md:px-10 md:py-3 md:text-base md:leading-6"
              >
      ...
      <div className="relative isolate overflow-hidden border-t border-gray-900 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
            <Image
              className="w-[48rem] max-w-none rounded-xl bg-gray-900 border border-gray-700 sm:w-[57rem]"
              src={screenshot}
        ...
        <div className="mx-auto px-6 lg:max-w-7xl">
          <div className="flex justify-center">
            <div className="md:w-3/4 lg:w-7/12">
              <Link
                href="/docs/getting-started/installation"
                className="flex w-full items-center justify-center rounded-md border border-transparent bg-white px-8 py-3 text-lg font-medium text-black no-underline hover:bg-gray-300 md:px-8 md:py-3 md:leading-6"
              >
                Get Started →
              </Link>
            </div>
